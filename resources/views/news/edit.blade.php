        ...
        <div class="row mt-5">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    <div class="panel-header"><h1>Editando</h1></div>
                    <div class="panel-body">
                        <form action="{{ route('news.update', $new)}}" method="post">
                            @csrf @method('PATCH')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="preview" id="preview" cols="112" rows="5" placeholder="{{ $new->preview }}"></textarea>
                                @error('preview')
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="ckeditor form-control" name="body" id="body" cols="30" rows="10" placeholder="{!! $new->body !!}"></textarea><br>
                                @error('body')
